##      PENDING : DOING THE INFERENCE USING SAVED KERAS MODEL AND SHOWING THE IMAGE IN FINAL WINDOW
## -----------------------------------------------------------------------------
...
## -----------------------------------------------------------------------------
## PENDING: Add label below the grid to show how many Selections still there. Keep color red, till the number is 5 or less
##          Add option to do inference and show the inference output image in a new window.
## -----------------------------------------------------------------------------
## 
...
class my_frm_enlarge:
    ...
    def do_inference_and_display_output(self):
        ...
        self.lbl_enlarged_img.configure(
            image=ImageTk.PhotoImage(Image.open(self.enlarge_this_image))
            )
