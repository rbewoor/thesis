...
class my_frm_enlarge:
    ...
    def perform_model_inference(self):
        ...
        print(f"\n\nExecuting model inference on image_to_infer : {self.enlarge_this_image}\n")
        ...
        image_to_infer_cv2 = cv2.imread(self.enlarge_this_image)
        image_h, image_w, _ = image_to_infer_cv2.shape
        try:
            image_to_infer_preprocessed = preprocess_input(image_to_infer_cv2, net_h, net_w)
