...
###           3) Provide option to toggle the Deselect button.
###              Show live count of Deselected images to help user.
###           4) Once Deselections confirmed, ensure total Selections is within maximum limit (currently 5).
###              If more were selected, then throw error message in the Root window and force
...
## 
##     c_my_root_window.root: tk.Root tpye
...
## 
##
##     2) MAIN WINDOW: Show grid of resiyed images with options to Deselect/Select and Enlarge, final Confimation 
##                          button, and count of currently Selected images.
## 
##     c_my_wnd_main_window.wnd: tk.Toplevel type
##     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
##     x                            Window title = "Thumbnails and Selection Window -- Query number whatever"             x
##     x                                                                                                                  x
##     x                                                                                                                  x
##     x               This window uses a grid geometry manager with 8 rows and 5 columns.                                x
##     x                    The first 6 rows are related to the presention of the image thumbnai and related actions.     x
##     x                    The last two rows are a Label and Button spanning the entire 5 columns.                       x
##     x                                                                                                                  x
##     x                                                                                                                  x
##     x                 frame_arr: is a 6 row x 10 columns = 60 grid cells.                                              x
##     x                            Alternating rows for:                                                                 x
##     x                                       resized image as thumbnai Label,                                           x
##     x                                       Enlarge Button, and                                                        x
##     x                                       Selection button.                                                          x
##     x                            Shown below is the first three rows for first column as example.                      x
##     x                                  The same pattern repeats covering the entire 60 grid cells.                     x
##     x                                                                                                                  x
##     x                                                                                                                  x
##     x    ------------------------------------------------------------------------------------------------------        x
##     x    -                                                                                                    -        x
...
##     x    ------------------------------------------------------------------------------------------------------        x
##     x                                                                                                                  x
##     x    ## Till abvoe, we have finished rows 1 to 6 of the grid patterns covering image related labels and buttons    #
##     x       Below shows the one Label and one Button spanning the entire width of 5 columns in rows 7 and 8            x
##     x                                                                                                                  x
##     x    ------------------------------------------------------------------------------------------------------        x
##     x    -                                    Label:lbl_track_selected_count                                  -        x
##     x    ------------------------------------------------------------------------------------------------------        x
##     x                                                                                                                  x
##     x    ------------------------------------------------------------------------------------------------------        x
##     x    -                                            Button: btn_done                                        -        x
...
## 
##
##     3) ENLARGE WINDOW: show particular image in original size, its location and option to perform inference.
## 
##     wnd_enlarged_img: tk.Toplevel type
##     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
##     x                                         Window title = "Enlarged image: ImageName.jpg"                           x
##     x                                                                                                                  x
##     x                                                                                                                  x
##     x                  -----------------------------------------------------------------------------                   x
...
## 
##
##     4) INFERENCE WINDOW: show image with objects detected, the original image path, detection info texttually.
## 
##     wnd_inference_img: tk.Toplevel type: from class my_frm_enlarge
##     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
##     x                                         Window title = "Inference for: ImageName.jpg"                            x
##     x                                                                                                                  x
##     x                                                                                                                  x
##     x                  -----------------------------------------------------------------------------                   x
...
##     x                                                                                                                  x
##     x                  -----------------------------------------------------------------------------                   x
##     x                  -                           Label: lbl_path_img_inferred                    -                   x
##     x                  -----------------------------------------------------------------------------                   x
##     x                                                                                                                  x
##     x                  -----------------------------------------------------------------------------                   x
##     x                  -                           Label: lbl_inference_textual_info               -                   x
##     x                  -----------------------------------------------------------------------------                   x
##     x                                                                                                                  x
##     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
## 
    ...
    def draw_boxes(self, image, boxes, labels, obj_thresh, _inference_text_info_arr):
        ...
        for box in boxes:
            ...
            if label >= 0:
                ...
                #             1e-3 * image.shape[0], 
                #             (0,255,0), 2)
                text_to_superimpose_in_image = f"{serial_num_object_box_at_loop_start}) {label_str} {box.get_score():.2f}%"
                cv2.putText(image, 
