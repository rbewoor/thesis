...
def select_images_functionality_for_one_query_result(_DEBUG_SWITCH, _query_num, _each_query_result):
    ...
    msg_in_label_for_root = r'DO NOT CLOSE THIS WINDOW TILL ALL SELECTIONS COMPLETE FOR THIS QUERY!!!'
    root = tk.Tk()
    ...
    bg="black", fg="white",
    command=partial(show_grid_selection_window, root, _each_query_result, _query_num, \
                     root.done_button_deselected_positions_results)
    )
