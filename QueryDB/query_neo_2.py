### Goal: Query Neo4j database to find images that contain the objects of interest.
##       
##         Objects of interest is read from a file specified in a command line argument.
##
