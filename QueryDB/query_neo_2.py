...
## 1) -objarr :    the objects to search while querying database.
##                 List of lists.
##                 Each inner list can have between one to three elements.
##                 e.g. [ ['dog', 'cat'], ['person', 'book'], ['person', 'car'] ]
## 
## Usage example:
##    python3 query_neo_1.py -objarr '[ ["dog", "cat"], ["person", "book"], ["person", "car"] ]'
## 
import argparse
...
def check_input_data(_key_elements_list):
    ...
    3) All inner list elements to be strings.
    VARIABLES PASSED:
    ...
    RETURNS:
          1) return code = 0 means all ok, non-zero means problem
            ...
            110         input data type is not a list
