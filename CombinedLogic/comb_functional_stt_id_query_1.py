...
##     Outputs:
##        a) One text file:
##           for ALL words that are not Stopwords, their comprehensive nlp info from Spacy.
##        b) Intermediate data:
...
def execute_control_logic(args):
    ...
    if stt_logic_RC == 0:
        ...
        print(f"\n\nFATAL ERROR: STT logic failed.\n\tReturn code = {stt_logic_RC}\n\tMessage = {stt_logic_msg}")
        print(f"\n\nPremature Exit.\n\n")
        exit()
    ...
    if id_elements_logic_RC == 0:
        ...
        print(f"\n\nFATAL ERROR: Identify keywords logic failed.\n\tReturn code = {query_neo4j_logic_RC}\n\tMessage = {query_neo4j_logic_msg}")
        print(f"\n\nPremature Exit.\n\n")
        exit()
    ...
    if query_neo4j_logic_RC == 0:
        ...
        print(f"\n\nFATAL ERROR: Database query logic failed.\n\tReturn code = {query_neo4j_logic_RC}\n\tMessage = {query_neo4j_logic_msg}")
        print(f"\n\nPremature Exit.\n\n")
        exit()
