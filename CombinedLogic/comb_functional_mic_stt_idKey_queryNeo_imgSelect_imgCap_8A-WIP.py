...
###          any images.
###       Then, save the data structure output after GUI presentation of Image Captioning results to file
...
def execute_control_logic(args):
    ...
    if img_cap_inference_logic_RC == 0:
        ...
        print_and_log(myStr, "info")
        myStr = None
        gui_img_cap_show_results_logic_RC, gui_img_cap_show_results_logic_msg, gui_img_cap_module_results = gui_img_cap_show_gui_functionality(img_cap_inference_module_results, file4stygen, DEBUG_SWITCH)
        myStr = "\n".join([
