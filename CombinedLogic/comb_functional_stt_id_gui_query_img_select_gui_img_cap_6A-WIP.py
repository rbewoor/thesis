...
def img_cap_inference_functionality(_id_elements_module_results, _gui_candidate_image_selection_module_results, _DEBUG_SWITCH):
    """
...
## ********** -------------  **************** ------------------ ****************
    ...
    print_and_log(myStr, 'info')
    myStr = None
    img_cap_inference_logic_RC, img_cap_inference_logic_msg, img_cap_inference_module_results = img_cap_inference_functionality(id_elements_module_results, gui_candidate_image_selection_module_results, DEBUG_SWITCH)
    myStr = "\n".join([
