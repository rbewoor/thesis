...
def execute_control_logic(args):
    ...
    ## show the result if no problem - for readability, match the keywords against the candidate images retrieved
    ...
    ## show the result if no problem - for readability, match the keywords against the finally selected images
    ...
    if all( ele== [] for ele in gui_candidate_image_selection_module_results ):
        ...
        myStr = "\n".join([
            ...
            f"No further processing to Auto Caption stage.\n\n"
            ])
        print_and_log(myStr, 'error')
        return
    
    ## do the auto caption block logic processing
    if query_neo4j_logic_RC == 0:
        myStr = "\n".join([
            f"\n\n-------------------------------------------------------------------",
            f"-------------------------------------------------------------------",
